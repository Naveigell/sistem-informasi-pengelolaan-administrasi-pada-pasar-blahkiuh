...
class PengeluaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengeluaran.index')->with('success', 'Berhasil menambah data pengeluaran');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengeluaran.index')->with('success', 'Berhasil mengubah data pengeluaran');
    }
    ...
    public function cetak()
    {
        ...
        $pdf->loadView('pengeluaran.cetak', $data);
        return $pdf->stream();
    }
}
